...
export default class ML extends PureComponent{

    render() {
        return (
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="white" viewBox="0 0 448 512" display="block" vertical-allign='middle'>
